...
This notebook contains the code for creating density maps of crimes in
St. Louis:
...
![](densityMap-p1_files/figure-gfm/create-map-1.png)<!-- -->
...
```
    ...
    ## Map saved to /Users/chris/GitHub/Personal/STL_CRIME_Belmar/results/density_map_p1.png
